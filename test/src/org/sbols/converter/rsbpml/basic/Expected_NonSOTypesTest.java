 ...
 * @author mgaldzic
 */
public class Expected_NonSOTypesTest {
    ...
    public void Expected_NonSOTypesTest() throws JAXBException, IOException {
        ...
        WriteFile.toPath(SbolDoc, "test/data/rdfout/NonSOTypes_Out.sbol.xml");

        //Get expected result
        String expected = ReadFile.fromPath("test/data/basic/NonSOTypes_Expected.sbol.xml");
