...
public class Expected_SpecifiedSubscarSubPartFeature_Test {
    @Test
    public void Expected_TitleBBa_AlreadyASpecifiedSubscarSubPartFeature_Test() throws JAXBException, IOException {
        ...
        //Get input for test
        Rsbpml rsbpmlData = ReadRSBPML.file("test/data/features/TitleBBa/AlreadyASubPart/TitleBBa_AlreadyASpecifiedSubscarSubPartFeature_Test.xml");
        //Do the test
        ...
        //Get expected result
        String expected = ReadFile.fromPath("test/data/features/TitleBBa/AlreadyASubPart/TitleBBa_AlreadyASpecifiedSubscarSubPartFeature_Expected.sbol.xml");
        //Compare
