...
public class Expected_DeepSubPartFeature_Test {
    ...
    public void Expected_TitleBBa_AlreadyADeepSubPartFeature_Test() throws JAXBException, IOException {
        ...
        //Get input for test
        Rsbpml rsbpmlData = ReadRSBPML.file("test/data/features/TitleBBa/AlreadyASubPart/TitleBBa_AlreadyADeepSubPartFeature_Test.xml");
        //Do the test
        ...
        //Get expected result
        String expected = ReadFile.fromPath("test/data/features/TitleBBa/AlreadyASubPart/TitleBBa_AlreadyADeepSubPartFeature_Expected.sbol.xml");
        //Compare
